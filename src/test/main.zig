...
test "issue34" { try runFixture(std.testing.allocator, @embedFile("fixtures/issue34.json"), 138); }
...
test "issue52" { try runFixture(std.testing.allocator, @embedFile("fixtures/issue52.json"), 108); }
...
test "eberly-6" { try runFixture(std.testing.allocator, @embedFile("fixtures/eberly-6.json"), 1428); }
...
test "water2" { try runFixture(std.testing.allocator, @embedFile("fixtures/water2.json"), 1211); }
...
test "water-huge" { try runFixture(std.testing.allocator, @embedFile("fixtures/water-huge.json"), 5174); }
test "water-huge2" { try runFixture(std.testing.allocator, @embedFile("fixtures/water-huge2.json"), 4484); }
test "water-huge3" { try runFixture(std.testing.allocator, @embedFile("fixtures/water-huge3.json"), 15470); }
test "issue147" { try runFixture(std.testing.allocator, @embedFile("fixtures/issue147.json"), 30); }
test "self-tangent-1" { try runFixture(std.testing.allocator, @embedFile("fixtures/self-tangent-1.json"), 23); }
test "self-tangent-2" { try runFixture(std.testing.allocator, @embedFile("fixtures/self-tangent-2.json"), 25); }
test "self-tangent-3" { try runFixture(std.testing.allocator, @embedFile("fixtures/self-tangent-3.json"), 174); }
test "self-tangent-4" { try runFixture(std.testing.allocator, @embedFile("fixtures/self-tangent-4.json"), 3082); }
